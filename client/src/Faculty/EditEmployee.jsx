    ...
    <div className='d-flex flex-column align-items-center pt-4'>
			...
			<form class="row g-3 w-50">
				...
				<div class="col-12">
					...
					<input type="text" class="form-control" id="inputdepart" placeholder="Department" autoComplete='off' value={data.department}/>
				</div>
				...
				<div class="col-12">
					<button type="submit" class="btn btn-primary" onSubmit={handleSubmit}>Update</button>
				</div>
			</form>
		</div>
  )
